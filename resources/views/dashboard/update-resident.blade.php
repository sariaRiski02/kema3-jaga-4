      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="rounded-xl border border-purple-100 bg-purple-50/40 p-3">
          ...
          <div x-show="editing.date_of_birth" x-transition class="mt-2">
            <input type="date" id="tanggal_lahir" name="date_of_birth" value="{{ old('date_of_birth', $resident->date_of_birth?->format('Y-m-d')) }}" class="input px-4 py-3 w-full" required>
        ...
        <div class="md:col-span-2 rounded-xl border border-purple-100 bg-purple-50/40 p-3">
          ...
          <div x-show="editing.date_of_death" x-transition class="mt-2">
            <input type="date" id="tanggal_kematian" name="date_of_death" value="{{ old('date_of_death', $resident->date_of_death?->format('Y-m-d')) }}" class="input px-4 py-3 w-full" placeholder="Tanggal Kematian">
        ...
        <div class="rounded-xl border border-purple-100 bg-purple-50/40 p-3">
          ...
          <div x-show="editing.education" x-transition class="mt-2">
            <select id="pendidikan" name="education" class="input px-4 py-3 w-full">
              ...
              <option value="sd" @selected(old('education', $resident->education) === 'sd')>SD</option>
              <option value="smp" @selected(old('education', $resident->education) === 'smp')>SMP</option>
              <option value="sma" @selected(old('education', $resident->education) === 'sma')>SMA</option>
              <option value="sd/sederajat" @selected(old('education', $resident->education) === 'sd/sederajat')>SD/Sederajat</option>
              <option value="sma/sederajat" @selected(old('education', $resident->education) === 'sma/sederajat')>SMA/Sederajat</option>
