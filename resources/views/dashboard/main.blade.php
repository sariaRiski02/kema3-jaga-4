...
<body class="bg-gray-50 text-gray-800 min-h-screen font-sans">
  ...
  <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 -translate-x-full bg-white border-r border-gray-200 transition-transform duration-300 flex flex-col">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
      ...
      <a href="{{ route('tambah-data') }}" class="{{ request()->is('tambah-data') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-purple-50 hover:text-purple-700' }} nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-purple-50 hover:text-purple-700 transition-colors">
        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="{{ route('data-warga') }}" class="{{ request()->is('data-warga') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-purple-50 hover:text-purple-700' }} nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-purple-50 hover:text-purple-700 transition-colors">
        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
